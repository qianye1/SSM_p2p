									...
									<div>
									 ...
									 <div>
									 	认证信息：
								 			...
								 			<#if userInfx.isBindPhone>
									 			<span class="glyphicon glyphicon-user"></span>
									 		</#if>
									 		<#if userInfx.isBindEmail>
