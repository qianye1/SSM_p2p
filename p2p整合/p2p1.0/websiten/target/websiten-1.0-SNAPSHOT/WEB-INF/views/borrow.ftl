			...
			<div class="el-borrow-item col-sm-4">
				...
				<div class="el-borrow-item-content">
					...
					<ul>
						...
						<li>
							<#if (userinf.authScore<creditBorrowScore)>
								<a href="#">userinf.authScore${userinf.authScore}分</a>
					...
					<#if userinf.isBasicInfo && userinf.isBindPhone && userinf.isBindEmail
					        && (userinf.authScore >= creditBorrowScore) >
