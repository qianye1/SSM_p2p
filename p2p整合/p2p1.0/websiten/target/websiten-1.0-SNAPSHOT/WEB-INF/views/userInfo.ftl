            ...
            <div class="panel panel-default">
                ...
                <form id="userInfoForm" class="form-horizontal" action="/userInfo_save.do" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <label id="phonenumber" name="phonenumber" style="width: 250px;" class="form-control">${(userinf.phoneNumber)!''}</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control" id="educationbackgroundItem" name="educationBackgroudItem.id"
                            ...
                            <script type="text/javascript">
                                $("#educationbackgroundItem option[value=${(userinf.educationBackgroudItem.id)!-1}]").attr("selected", true);
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#incomegradeItem option[value=${(userinf.incomeGradeItem.id)!-1}]").attr("selected", true);
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#marriageItem option[value=${(userinf.marriageItem.id)!-1}]").attr("selected", true);
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#kidcountItem option[value=${(userinf.kidCountItem.id)!-1}]").attr("selected", true);
                            </script>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <script type="text/javascript">
                                $("#houseconditionItem option[value=${(userinf.houseConditionItem.id)!-1}]").attr("selected", true);
                            </script>
                        </div>
                    </div>
